...
const Contribute = () => {
    return (
        <Container style={{ marginTop: '5%', width: '70%', backgroundSize: 'cover', backgroundPosition: 'center', height: '50vh', padding: '5%', backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0.4)), url(${Hands})`, borderRadius: '20px' }}>
            <Row>
